      ...
      body: Padding(
        ...
        child: ListView(
          children: const [
            ...
            SizedBox(height: 40),
            Text(
              "Disclaimer: The ScanIt app is independently developed and not affiliated, endorsed, or sponsored by OpenAI.",
              style: TextStyle(
            ...
            SizedBox(height: 10),
            Text(
                "The ScanIt app lets you send any image (screenshots, graphics or photos) with a text prompt to the OpenAI API and retrieve, store and display the response.\n\n"
                "1) Explain a meme.\n"
